...
// Language switcher - auto-initialize all .lang-container elements
document.querySelectorAll('.lang-container').forEach((container) => {
    ...
    const enContent = container.querySelector('.lang-content:first-of-type') as HTMLElement | null;
    const zhContent = container.querySelector('.lang-content:last-of-type') as HTMLElement | null;
    ...
    btn.addEventListener('click', () => {
        ...
        btn.setAttribute('data-tooltip', isActive ? 'Switch to Original Version' : 'Switch to Native Language Version');
    });
});
